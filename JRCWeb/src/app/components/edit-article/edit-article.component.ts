...
tags:any[]
authors:any[]
  constructor(private activatedRoute:ActivatedRoute, private http:HttpClient, public service:ArticleService,private categoryService:CategoryService,private tagService:TagService,private authorService:AuthorService) {
    super(service);
 ...
 this.article=res;
   ...
   editArticle(model:any){
    ...
    this.http.put('http://localhost:25442/api/article/edit/',model).subscribe(res=>{
      console.log(res)
